...
# Έλεγχος αν το λογισμικό εκτελείται με δικαιώματα διαχειριστή. Αν όχι γίνεται έξοδος
if [ $EUID -ne 0 ] ; then
    clear
    echo ""
...
echo 'Τώρα θα πρέπει να ρυθμίσετε τον υπολογιστή σας στο host αρχείο του να μεταφράζει το http://vtiger.businesspi.local στην IP : $serverip που έχει λάβει (ή θέσατε εσείς) για να να συνδεθείτε στο Vtiger'
echo ''
echo ''
